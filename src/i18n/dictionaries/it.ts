...
export const it = {
  ...
  promo: {
    codes: {
      WELCOME10: '10% di sconto sul primo ciclo',
      NB1: '15% di sconto sul primo ciclo',
      HYROX: '20% di sconto sul primo ciclo',
      FREEMONTH: 'Primo mese gratis',
    ...
    messages: {
      ...
      referralFirstMonthFree: '✓ Primo mese gratis con il tuo codice invito.',
    } as Record<string, string>,
  },
  checkout: {
    hero: {
    ...
    shipping: {
      ...
      expressName: 'Express',
      expressSub: '1–2 giorni lavorativi · tracciato',
      expressPrice: '€9',
    },
    payment: {
      applePay: 'Apple Pay',
      ...
      klarna: 'Klarna',
      klarnaNote:
        'Paga con Klarna, tramite fattura o bonifico istantaneo. Approvi il pagamento su Klarna; il primo addebito scatterà solo al momento della produzione.',
    ...
    confirm: {
      ...
      legalMid:
        ", e acconsenti al trattamento da parte di NB1 del tuo campione biologico e dei tuoi dati sanitari per l'elaborazione della formula. Il primo addebito avverrà circa due settimane dopo averci rispedito il campione, e solo quando la formula entrerà in produzione. Verrà applicata una commissione una tantum di ",
      feeBold: '{{fee:kit}}',
      legalEnd:
        'solo se non ci restituirai il campione entro 4 settimane. NB1 è riservato ai maggiori di 18 anni.',
      ...
      orderError: 'Non è stato possibile completare il tuo ordine:',
    },
    whatsNext: {
    ...
    summary: {
      ...
      note: 'Il primo addebito scatta circa due settimane dopo averci rispedito il campione, e solo nel momento in cui la tua formula entra in produzione. Mai prima. Applicheremo una tariffa una tantum di {{fee:kit}} solo se non ci restituirai il campione entro 4 settimane.',
    },
    done: {
      heading: 'Ci sei',
      ...
      inboxBody:
        'Abbiamo inviato la conferma a {email}. Aprila per impostare una password e accedere alla tua dashboard.',
