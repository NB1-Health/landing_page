export const fr = {
  ...
  research: {
    ...
    sections: {
      background: 'Contexte',
      studyDesign: 'Protocole de l’étude',
      keyFindings: 'Résultats clés',
      mechanism: 'Mécanisme',
      clinicalImplications: 'Portée clinique',
      limitations: 'Limites et questions ouvertes',
      inPlainLanguage: 'En langage clair',
    },
  },
  lexicon: {
    sections: {
      inSimpleTerms: 'En termes simples',
      scientificBackground: 'Contexte scientifique',
      roleInGutHealth: 'Rôle dans la santé intestinale',
    },
    alsoKnownAs: 'Aussi appelé',
    reviewedFor: 'Validé scientifiquement par',
    relatedTerms: 'Termes associés',
    readMore: 'Lire la suite',
    filterLabel: 'Filtrer les termes',
    filterPlaceholder: 'Filtrer {terms}, p. ex. butyrate',
    searchLabel: 'Rechercher dans le lexique',
    searchPlaceholder: 'Rechercher parmi {terms}, p. ex. butyrate',
    countOne: '{count} terme',
    countAll: '{count} termes',
    countFiltered: '{shown} sur {total} termes',
    searching: 'Recherche en cours…',
    resultsCapped: 'Les {shown} premiers résultats sur {total}. Continuez à taper pour affiner.',
    noMatch: 'Aucun terme ne correspond à ce filtre.',
    jumpToLetter: 'Aller à la lettre',
    backToTop: 'Haut de page',
    browseByCategory: 'Parcourir par catégorie',
    allTerms: 'Tous les termes A–Z',
  },
  theCase: {
    readMore: 'Lire la suite',
    back: 'Retour',
  ...
  forms: {
    ...
    contactMessagePlaceholder: "Comment pouvons-nous t'aider ?",
  ...
  plans: {
    ...
    orWord: 'ou', // conjunction in the "4 or 12 months" tab subtitle
  ...
  journal: {
    heroTitle: 'L’intestin, expliqué.',
    heroLede:
      'Des articles fondés sur les preuves à propos du microbiote, de la nutrition et de la science derrière une formule conçue pour toi. Écrits et relus par l’équipe NB1.',
    allTopics: 'Tout',
    readArticle: 'Lire l’article',
    minRead: 'min de lecture',
    featuredLabel: 'À la une',
    empty: 'Aucun article sur ce thème pour le moment.',
    ...
    navOverview: 'Aperçu',
    breadcrumbPage: 'Page',
    complianceLabel: 'Note sur les allégations :',
    ctaHeading: 'Conçu à partir de ta biologie, pas d’une supposition.',
    ctaBody: 'NB1 lit ton intestin et construit une formule faite uniquement pour toi.',
    ctaLabel: 'Voir comment ça marche',
    ctaPath: '/your-plan',
    exploreHubs: 'Explorer par thème',
    relatedTopics: 'Sujets connexes',
    lastReviewed: 'Dernière vérification',
    aboutAuthor: 'À propos de l’auteur',
    profile: 'Voir le profil complet',
