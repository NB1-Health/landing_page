export const en = {
  ...
  lexicon: {
    sections: {
      ...
      roleInGutHealth: 'Role in Gut Microbiome Health',
    },
    alsoKnownAs: 'Also known as',
    reviewedFor: 'Scientifically reviewed by',
    relatedTerms: 'Related terms',
    readMore: 'Read more',
    filterLabel: 'Filter terms',
    filterPlaceholder: 'Filter {terms}, e.g. butyrate',
    searchLabel: 'Search the lexicon',
    searchPlaceholder: 'Search {terms}, e.g. butyrate',
    countOne: '{count} term',
    countAll: '{count} terms',
    countFiltered: '{shown} of {total} terms',
    searching: 'Searching…',
    resultsCapped: 'Showing the first {shown} of {total} matches. Keep typing to narrow.',
    noMatch: 'No terms match that filter.',
    jumpToLetter: 'Jump to letter',
    backToTop: 'Back to top',
    browseByCategory: 'Browse by category',
    allTerms: 'All terms A–Z',
  },
  theCase: {
    readMore: 'Read more',
    back: 'Back',
  ...
  journal: {
    heroTitle: 'The gut, explained.',
    heroLede:
      'Evidence-led writing on the microbiome, nutrition, and the science behind a formula built for you. Written and reviewed by the NB1 team.',
    allTopics: 'All',
    ...
    breadcrumbPage: 'Page',
    complianceLabel: 'A note on claims:',
    ctaHeading: 'Built from your biology, not a guess.',
    ctaBody: 'NB1 reads your gut and builds a formula made only for you.',
    ctaLabel: 'See how it works',
    ctaPath: '/your-plan',
    exploreHubs: 'Explore by topic',
