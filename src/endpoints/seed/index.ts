...
export const seed = async ({
  ...
  // clear versions (only for collections that have versions enabled)
  await Promise.all(
    collections
  ...
  // only fetch what we still use (no post images)
  ...
  void demoUser // silence unused if you don't use it later
